            ...
            {loggedIn ? (
                <nav className="navigation">
                    <div className="navigation__logged">
                        ...
                        {['/'].includes(location.pathname) && <NavLink className='navigation__link' to="/movies">Фильмы</NavLink>}
                        {['/'].includes(location.pathname) && <NavLink className='navigation__link' to="/saved-movies">Сохранённые фильмы</NavLink>}
                    </div>
                    ...
                    {['/'].includes(location.pathname) && <NavLink className='navigation__link navigation__link_profile' to="/profile">
                        <span className="navigation__profile-title">Аккаунт</span>
                        <img className="navigation__profile-icon" src={profileIconBtn} alt="Иконка профиля"></img>
                    </NavLink>}
                </nav>
